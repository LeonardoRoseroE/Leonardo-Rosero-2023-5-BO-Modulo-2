...
class GameEnd:
    ...
    def draw(self, screen, bullet_count, death_count, score):
        screen.blit(END,(0,0))
        text = self.font.render("Congratulations you finished", True, (0, 255, 0))
        text_rect = text.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 50))
        screen.blit(text, text_rect)

        bullet_count_text = self.font.render(f"Score: {score}", True, (255, 255, 255))
        ...
        bullet_count_rect = bullet_count_text.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 50))
        screen.blit(bullet_count_text, bullet_count_rect)
